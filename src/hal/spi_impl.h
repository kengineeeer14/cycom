#ifndef CYCOM_SRC_HAL_SPI_IMPL_H_
#define CYCOM_SRC_HAL_SPI_IMPL_H_
...
class SpiImpl : public ISpi {
  public:
     ...
     */
    explicit SpiImpl(const char *dev, uint32_t speed_hz = 40000000, uint8_t mode = 0, uint8_t bits = 8);
...
#endif  // CYCOM_SRC_HAL_SPI_IMPL_H_
